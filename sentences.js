    ...
    "sentenceGrammarNotes": [
      {
        ...
        "details": "Die Wortgruppe bis zum dritten Werktag zeigt, wann die Miete bezahlt sein soll. Im Hauptsatz steht das finite Verb verlangt an Position 2: Der Vermieter | verlangt | die Miete ...",
        "example": "bis zum dritten Werktag"
      },
      {
        "title": "Verb auf Position 2",
        "summary": "Im Hauptsatz steht das finite Verb hier an zweiter Stelle.",
        "details": "Zuerst kommt das Subjekt Der Vermieter, dann das finite Verb verlangt. Danach folgen die restlichen Satzteile.",
        "example": "Der Vermieter | verlangt | die Miete ..."
      }
    ],
    "vocabularyLinks": [
      "der Vermieter",
    ...
    "sentenceGrammarNotes": [
      {
        ...
        "details": "Im ersten Teil steht Hätte als finites Verb ganz vorne, weil der Konditionalsatz ohne wenn beginnt. Reagiert steht am Ende des ersten Teils. Im zweiten Satzteil steht wäre früh im Satz, und gewesen schließt die Form ganz am Ende ab.",
        "example": "Hätte die Regierung früher reagiert, wäre der Mangel ... kleiner gewesen."
      },
      {
        "title": "der Mangel an etwas",
        "summary": "Man sagt: der Mangel an + Dativ.",
        "details": "Hier fehlt es an bezahlbaren Wohnungen. Deshalb steht nach Mangel die feste Verbindung an bezahlbaren Wohnungen.",
        "example": "der Mangel an bezahlbaren Wohnungen"
      }
    ],
    "vocabularyLinks": [
      "reagieren",
    ...
    "sentenceGrammarNotes": [
      {
        ...
        "details": "Im Satz stehen beide Möglichkeiten klar nebeneinander: rechtzeitig zahlen oder eine Abmahnung bekommen. In beiden Hauptsätzen steht das finite Verb an Position 2: Sie | überweisen ... / Sie | erhalten ...",
    ...
    "sentenceGrammarNotes": [
      {
        ...
        "details": "Im ersten Teil bleibt die normale Hauptsatzstellung: das Dach | ist | undicht. Im zweiten Teil steht wieder ein Hauptsatz mit Verb auf Position 2: es | gibt | auch Probleme ...",
      ...
      },
      {
        ...
        "details": "Es steht auf Position 1, gibt auf Position 2. Danach kommt der Rest des Satzes: auch Probleme mit der Statik der Mauer.",
        "example": "sondern es gibt auch Probleme ..."
      }
    ],
    "vocabularyLinks": [
      "das Dach",
    ...
    "sentenceGrammarNotes": [
      {
        ...
        "details": "Nach entweder beginnt hier ein normaler Hauptsatz: der Lift | wird | repariert. Nach oder beginnt wieder ein Hauptsatz mit Verb auf Position 2: die Mieter | nehmen | weiter die Treppe.",
        "example": "Entweder der Lift wird repariert, oder ..."
      },
      {
        "title": "Verbposition in beiden Teilen",
        "summary": "In beiden Satzteilen bleibt das finite Verb auf Position 2.",
        "details": "Erster Teil: der Lift | wird | repariert. Zweiter Teil: die Mieter | nehmen | weiter die Treppe. Der Konnektor zählt nicht als Verb und ändert die Grundregel nicht.",
        "example": "Entweder der Lift wird repariert, oder die Mieter nehmen weiter die Treppe."
      }
    ],
    "vocabularyLinks": [
      "entweder",
    ...
    "sentenceGrammarNotes": [
      {
        ...
        "details": "Im ersten Teil steht Hätte auf Position 1, weil der Satz ohne wenn beginnt; reagiert steht am Ende dieses Teils. Im zweiten Teil steht wäre früh im Hauptsatz und gewesen schließt die Form am Satzende ab.",
  ...
  },
  {
    ...
    "sentenceGrammarNotes": [
      ...
      },
      {
        ...
        "details": "Im ersten Teil steht Hätte am Anfang, entdeckt schließt den ersten Verbkomplex ab. Nach dem eingeschobenen wie-Satz folgt der zweite Teil wieder mit hätte auf Position 1 und gekauft am Ende.",
